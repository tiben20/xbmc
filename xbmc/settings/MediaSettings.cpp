...
void CMediaSettings::OnSettingAction(const std::shared_ptr<const CSetting>& setting)
{
  ...
  {
    CServiceBroker::GetSettingsComponent()->GetSettings()->SetInt(CSettings::SETTING_DSPLAYER_DSAREALEFT, 0);
    CServiceBroker::GetSettingsComponent()->GetSettings()->SetInt(CSettings::SETTING_DSPLAYER_DSAREARIGHT, 0);
    CServiceBroker::GetSettingsComponent()->GetSettings()->SetInt(CSettings::SETTING_DSPLAYER_DSAREATOP, 0);
    CServiceBroker::GetSettingsComponent()->GetSettings()->SetInt(CSettings::SETTING_DSPLAYER_DSAREABOTTOM, 0);
  }
