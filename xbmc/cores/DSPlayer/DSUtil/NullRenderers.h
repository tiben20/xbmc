...
interface __declspec(uuid("579883A0-4E2D-481F-9436-467AAFAB7DE8")) CNullVideoRenderer : public CNullRenderer
{
protected:
...
interface __declspec(uuid("DD9ED57D-6ABF-42E8-89A2-11D04798DC58")) CNullUVideoRenderer : public CNullRenderer
{
protected:
  HRESULT CheckMediaType(const CMediaType* pmt);
...
interface __declspec(uuid("0C38BDFD-8C17-4E00-A344-F89397D3E22A")) CNullAudioRenderer : public CNullRenderer
{
protected:
  HRESULT CheckMediaType(const CMediaType* pmt);
...
interface __declspec(uuid("64A45125-7343-4772-9DA4-179FAC9D462C")) CNullUAudioRenderer : public CNullRenderer
{
protected:
  HRESULT CheckMediaType(const CMediaType* pmt);
...
interface __declspec(uuid("655D7613-C26C-4A25-BBBD-3C9C516122CC")) CNullTextRenderer : public CBaseFilter, public CCritSec
{
