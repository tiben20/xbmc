...
BOOL CRegistry::CreateKey(CStdString strKey)
{
...
BOOL CRegistry::DeleteKey(CStdString strKey)
{
...
BOOL CRegistry::DeleteValue(CStdString strName)
{
...
int CRegistry::GetDataSize(CStdString strValueName)
{
...
DWORD CRegistry::GetDataType(CStdString strValueName)
{
	HKEY hKey;
	ASSERT(m_strCurrentPath.GetLength() > 0);
...
BOOL CRegistry::KeyExists(CStdString strKey, HKEY hRootKey)
{
...
BOOL CRegistry::SetKey(CStdString strKey, BOOL bCanCreate)
{
...
BOOL CRegistry::ValueExists(CStdString strName)
{
...
void CRegistry::RenameValue(CStdString strOldName, CStdString strNewName)
{
...
/*COleDateTime CRegistry::ReadDateTime(CStdString strName, COleDateTime dtDefault)
{
...
double CRegistry::ReadFloat(CStdString strName, double fDefault)
{
...
CStdString CRegistry::ReadString(CStdString strName, CStdString strDefault)
{
	DWORD dwType = REG_SZ;
	DWORD dwSize = 255;
	BOOL bSuccess = TRUE;
	...
	return CStdString((LPCTSTR)sz);
}

BOOL CRegistry::ReadDword(CStdString strName, DWORD& dwDefault)
{
	...
	ASSERT(m_strCurrentPath.GetLength() > 0);
	if (::RegOpenKeyEx(m_hRootKey, LPCTSTR(m_strCurrentPath), 0,
		KEY_READ, &hKey) != ERROR_SUCCESS) return 0;

	if (::RegQueryValueEx(hKey, LPCTSTR(strName), NULL,
		&dwType, reinterpret_cast<LPBYTE>(&dwDefault), &dwSize) != ERROR_SUCCESS)
	{
		::RegCloseKey(hKey);
		return 0;
	}
...
int CRegistry::ReadInt(CStdString strName, int nDefault)
{
	DWORD dwType = REG_BINARY;
	int n;
...
BOOL CRegistry::ReadBool(CStdString strName, BOOL bDefault)
{
	DWORD dwType = REG_BINARY;
	BOOL b;
...
COLORREF CRegistry::ReadColor(CStdString strName, COLORREF rgbDefault)
{
	DWORD dwType = REG_BINARY;
	COLORREF rgb;
...
/*BOOL CRegistry::ReadFont(CStdString strName, CFont* pFont)
{
	DWORD dwType = REG_BINARY;
...
BOOL CRegistry::ReadPoint(CStdString strName, Com::SmartPoint* pPoint)
{
	DWORD dwType = REG_BINARY;
	DWORD dwSize = sizeof(Com::SmartPoint);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::ReadSize(CStdString strName, Com::SmartSize* pSize)
{
	DWORD dwType = REG_BINARY;
	DWORD dwSize = sizeof(Com::SmartSize);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::ReadRect(CStdString strName, Com::SmartRect* pRect)
{
	DWORD dwType = REG_BINARY;
	DWORD dwSize = sizeof(Com::SmartRect);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::WriteBool(CStdString strName, BOOL bValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
/*BOOL CRegistry::WriteDateTime(CStdString strName, COleDateTime dtValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::WriteString(CStdString strName, CStdString strValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
#ifdef _UNICODE
	if (::RegSetValueEx(hKey, LPCTSTR(strName), 0,
		REG_SZ, (LPBYTE)sz, strValue.GetLength() + 1)
		 != ERROR_SUCCESS) bSuccess = FALSE;
#else
	if (::RegSetValueEx(hKey, LPCTSTR(strName), 0,
...
BOOL CRegistry::WriteFloat(CStdString strName, double fValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::WriteInt(CStdString strName, int nValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::WriteDword(CStdString strName, DWORD dwValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::WriteColor(CStdString strName, COLORREF rgbValue)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
/*BOOL CRegistry::WriteFont(CStdString strName, CFont* pFont)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
...
BOOL CRegistry::WritePoint(CStdString strName, Com::SmartPoint* pPoint)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
	...
	if (::RegSetValueEx(hKey, LPCTSTR(strName), 0,
		REG_BINARY, (LPBYTE)pPoint, sizeof(Com::SmartPoint))
		 != ERROR_SUCCESS) bSuccess = FALSE;
...
BOOL CRegistry::WriteSize(CStdString strName, Com::SmartSize* pSize)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
	...
	if (::RegSetValueEx(hKey, LPCTSTR(strName), 0,
		REG_BINARY, (LPBYTE)pSize, sizeof(Com::SmartSize))
		 != ERROR_SUCCESS) bSuccess = FALSE;
...
BOOL CRegistry::WriteRect(CStdString strName, Com::SmartRect* pRect)
{
	ASSERT(m_strCurrentPath.GetLength() > 0);
	BOOL bSuccess = TRUE;
	HKEY hKey;
	...
	if (::RegSetValueEx(hKey, LPCTSTR(strName), 0,
		REG_BINARY, (LPBYTE)pRect, sizeof(Com::SmartRect))
		 != ERROR_SUCCESS) bSuccess = FALSE;
